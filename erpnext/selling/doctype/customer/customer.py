...
class Customer(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		customer_type: DF.Literal["Company", "Individual", "Partnership", "Personne Physique", "Personne Morale", "Personne physique Commerçante", "Profession Libérale", "Ambassade et Organisation Internationale"]
